...
export interface ApiEnquiryEnquiry extends Schema.CollectionType {
  collectionName: 'enquirys';
  info: {
    singularName: 'enquiry';
    pluralName: 'enquirys';
    displayName: 'Enquirys';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiVenueVenue extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bookings: Attribute.Relation<
      ...
      'api::booking.booking'
    >;
    enquirys: Attribute.Relation<
      'api::venue.venue',
      'oneToMany',
      'api::enquiry.enquiry'
    >;
    PetFriendly: Attribute.Boolean;
    NumberOfBeds: Attribute.Integer;
    NumberOfBedrooms: Attribute.Integer;
    NumberOfBathrooms: Attribute.Integer;
    Kitchen: Attribute.Boolean;
    TV: Attribute.Boolean;
    WirelessNetwork: Attribute.Boolean;
    FreeParking: Attribute.Boolean;
    WashingMachine: Attribute.Boolean;
    Dryer: Attribute.Boolean;
    AirConditioning: Attribute.Boolean;
    Balcony: Attribute.Boolean;
    Fireplace: Attribute.Boolean;
